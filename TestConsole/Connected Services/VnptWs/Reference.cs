...
namespace TestConsole.VnptWs {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="VnptWs.SendMT2Soap")]
    public interface SendMT2Soap {
        ...
        TestConsole.VnptWs.SendSMSResponse SendSMS(TestConsole.VnptWs.SendSMSRequest request);
        
        // CODEGEN: Generating message contract since element name account_name from namespace http://tempuri.org/ is not marked nillable
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/SendSMSAdvert", ReplyAction="*")]
        TestConsole.VnptWs.SendSMSAdvertResponse SendSMSAdvert(TestConsole.VnptWs.SendSMSAdvertRequest request);
    }
    ...
    public partial class SendSMSRequest {
        ...
        public TestConsole.VnptWs.SendSMSRequestBody Body;
        
        public SendSMSRequest() {
        }
        
        public SendSMSRequest(TestConsole.VnptWs.SendSMSRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SendSMSResponse {
        ...
        public TestConsole.VnptWs.SendSMSResponseBody Body;
        
        public SendSMSResponse() {
        }
        
        public SendSMSResponse(TestConsole.VnptWs.SendSMSResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SendSMSAdvertRequest {
        ...
        public TestConsole.VnptWs.SendSMSAdvertRequestBody Body;
        
        public SendSMSAdvertRequest() {
        }
        
        public SendSMSAdvertRequest(TestConsole.VnptWs.SendSMSAdvertRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SendSMSAdvertResponse {
        ...
        public TestConsole.VnptWs.SendSMSAdvertResponseBody Body;
        
        public SendSMSAdvertResponse() {
        }
        
        public SendSMSAdvertResponse(TestConsole.VnptWs.SendSMSAdvertResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface SendMT2SoapChannel : TestConsole.VnptWs.SendMT2Soap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SendMT2SoapClient : System.ServiceModel.ClientBase<TestConsole.VnptWs.SendMT2Soap>, TestConsole.VnptWs.SendMT2Soap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        TestConsole.VnptWs.SendSMSResponse TestConsole.VnptWs.SendMT2Soap.SendSMS(TestConsole.VnptWs.SendSMSRequest request) {
        ...
        public int SendSMS(string account_name, string account_password, string User_ID, string Content, string Service_ID, string Command_Code, string Request_ID, string Message_Type, string Total_Message, string Message_Index, string IsMore, string Content_Type) {
            TestConsole.VnptWs.SendSMSRequest inValue = new TestConsole.VnptWs.SendSMSRequest();
            inValue.Body = new TestConsole.VnptWs.SendSMSRequestBody();
            ...
            TestConsole.VnptWs.SendSMSResponse retVal = ((TestConsole.VnptWs.SendMT2Soap)(this)).SendSMS(inValue);
