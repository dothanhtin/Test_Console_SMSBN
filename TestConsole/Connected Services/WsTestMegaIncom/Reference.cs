...
namespace TestConsole.WsTestMegaIncom {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="WsTestMegaIncom.SendMT2Soap")]
    public interface SendMT2Soap {
        ...
        TestConsole.WsTestMegaIncom.SendSMSResponse SendSMS(TestConsole.WsTestMegaIncom.SendSMSRequest request);
        
        // CODEGEN: Generating message contract since element name account_name from namespace http://tempuri.org/ is not marked nillable
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/SendSMSAdvert", ReplyAction="*")]
        TestConsole.WsTestMegaIncom.SendSMSAdvertResponse SendSMSAdvert(TestConsole.WsTestMegaIncom.SendSMSAdvertRequest request);
    }
    ...
    public partial class SendSMSRequest {
        ...
        public TestConsole.WsTestMegaIncom.SendSMSRequestBody Body;
        
        public SendSMSRequest() {
        }
        
        public SendSMSRequest(TestConsole.WsTestMegaIncom.SendSMSRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SendSMSResponse {
        ...
        public TestConsole.WsTestMegaIncom.SendSMSResponseBody Body;
        
        public SendSMSResponse() {
        }
        
        public SendSMSResponse(TestConsole.WsTestMegaIncom.SendSMSResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SendSMSAdvertRequest {
        ...
        public TestConsole.WsTestMegaIncom.SendSMSAdvertRequestBody Body;
        
        public SendSMSAdvertRequest() {
        }
        
        public SendSMSAdvertRequest(TestConsole.WsTestMegaIncom.SendSMSAdvertRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SendSMSAdvertResponse {
        ...
        public TestConsole.WsTestMegaIncom.SendSMSAdvertResponseBody Body;
        
        public SendSMSAdvertResponse() {
        }
        
        public SendSMSAdvertResponse(TestConsole.WsTestMegaIncom.SendSMSAdvertResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface SendMT2SoapChannel : TestConsole.WsTestMegaIncom.SendMT2Soap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SendMT2SoapClient : System.ServiceModel.ClientBase<TestConsole.WsTestMegaIncom.SendMT2Soap>, TestConsole.WsTestMegaIncom.SendMT2Soap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        TestConsole.WsTestMegaIncom.SendSMSResponse TestConsole.WsTestMegaIncom.SendMT2Soap.SendSMS(TestConsole.WsTestMegaIncom.SendSMSRequest request) {
        ...
        public int SendSMS(string account_name, string account_password, string User_ID, string Content, string Service_ID, string Command_Code, string Request_ID, string Message_Type, string Total_Message, string Message_Index, string IsMore, string Content_Type) {
            TestConsole.WsTestMegaIncom.SendSMSRequest inValue = new TestConsole.WsTestMegaIncom.SendSMSRequest();
            inValue.Body = new TestConsole.WsTestMegaIncom.SendSMSRequestBody();
            ...
            TestConsole.WsTestMegaIncom.SendSMSResponse retVal = ((TestConsole.WsTestMegaIncom.SendMT2Soap)(this)).SendSMS(inValue);
            return retVal.Body.SendSMSResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        TestConsole.WsTestMegaIncom.SendSMSAdvertResponse TestConsole.WsTestMegaIncom.SendMT2Soap.SendSMSAdvert(TestConsole.WsTestMegaIncom.SendSMSAdvertRequest request) {
        ...
        public int SendSMSAdvert(string account_name, string account_password, string Phonenumber, string Message, string SendFrom, string CommandCode, string RequestID) {
            TestConsole.WsTestMegaIncom.SendSMSAdvertRequest inValue = new TestConsole.WsTestMegaIncom.SendSMSAdvertRequest();
            inValue.Body = new TestConsole.WsTestMegaIncom.SendSMSAdvertRequestBody();
            inValue.Body.account_name = account_name;
            inValue.Body.account_password = account_password;
            ...
            TestConsole.WsTestMegaIncom.SendSMSAdvertResponse retVal = ((TestConsole.WsTestMegaIncom.SendMT2Soap)(this)).SendSMSAdvert(inValue);
