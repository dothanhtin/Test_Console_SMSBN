...
namespace TestConsole.ws_Test_cloud {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ws_Test_cloud.SendMT2Soap")]
    public interface SendMT2Soap {
        ...
        TestConsole.ws_Test_cloud.SendSMSResponse SendSMS(TestConsole.ws_Test_cloud.SendSMSRequest request);
        
        // CODEGEN: Generating message contract since element name account_name from namespace http://tempuri.org/ is not marked nillable
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/SendSMSAdvert", ReplyAction="*")]
        TestConsole.ws_Test_cloud.SendSMSAdvertResponse SendSMSAdvert(TestConsole.ws_Test_cloud.SendSMSAdvertRequest request);
    }
    ...
    public partial class SendSMSRequest {
        ...
        public TestConsole.ws_Test_cloud.SendSMSRequestBody Body;
        
        public SendSMSRequest() {
        }
        
        public SendSMSRequest(TestConsole.ws_Test_cloud.SendSMSRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SendSMSResponse {
        ...
        public TestConsole.ws_Test_cloud.SendSMSResponseBody Body;
        
        public SendSMSResponse() {
        }
        
        public SendSMSResponse(TestConsole.ws_Test_cloud.SendSMSResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SendSMSAdvertRequest {
        ...
        public TestConsole.ws_Test_cloud.SendSMSAdvertRequestBody Body;
        
        public SendSMSAdvertRequest() {
        }
        
        public SendSMSAdvertRequest(TestConsole.ws_Test_cloud.SendSMSAdvertRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SendSMSAdvertResponse {
        ...
        public TestConsole.ws_Test_cloud.SendSMSAdvertResponseBody Body;
        
        public SendSMSAdvertResponse() {
        }
        
        public SendSMSAdvertResponse(TestConsole.ws_Test_cloud.SendSMSAdvertResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface SendMT2SoapChannel : TestConsole.ws_Test_cloud.SendMT2Soap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SendMT2SoapClient : System.ServiceModel.ClientBase<TestConsole.ws_Test_cloud.SendMT2Soap>, TestConsole.ws_Test_cloud.SendMT2Soap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        TestConsole.ws_Test_cloud.SendSMSResponse TestConsole.ws_Test_cloud.SendMT2Soap.SendSMS(TestConsole.ws_Test_cloud.SendSMSRequest request) {
        ...
        public int SendSMS(string account_name, string account_password, string User_ID, string Content, string Service_ID, string Command_Code, string Request_ID, string Message_Type, string Total_Message, string Message_Index, string IsMore, string Content_Type) {
            TestConsole.ws_Test_cloud.SendSMSRequest inValue = new TestConsole.ws_Test_cloud.SendSMSRequest();
            inValue.Body = new TestConsole.ws_Test_cloud.SendSMSRequestBody();
            ...
            TestConsole.ws_Test_cloud.SendSMSResponse retVal = ((TestConsole.ws_Test_cloud.SendMT2Soap)(this)).SendSMS(inValue);
            return retVal.Body.SendSMSResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        TestConsole.ws_Test_cloud.SendSMSAdvertResponse TestConsole.ws_Test_cloud.SendMT2Soap.SendSMSAdvert(TestConsole.ws_Test_cloud.SendSMSAdvertRequest request) {
        ...
        public int SendSMSAdvert(string account_name, string account_password, string Phonenumber, string Message, string SendFrom, string CommandCode, string RequestID) {
            TestConsole.ws_Test_cloud.SendSMSAdvertRequest inValue = new TestConsole.ws_Test_cloud.SendSMSAdvertRequest();
            inValue.Body = new TestConsole.ws_Test_cloud.SendSMSAdvertRequestBody();
            inValue.Body.account_name = account_name;
            inValue.Body.account_password = account_password;
            ...
            TestConsole.ws_Test_cloud.SendSMSAdvertResponse retVal = ((TestConsole.ws_Test_cloud.SendMT2Soap)(this)).SendSMSAdvert(inValue);
