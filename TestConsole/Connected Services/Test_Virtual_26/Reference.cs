...
namespace TestConsole.Test_Virtual_26 {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="Test_Virtual_26.SendMT2Soap")]
    public interface SendMT2Soap {
        ...
        TestConsole.Test_Virtual_26.SendSMSResponse SendSMS(TestConsole.Test_Virtual_26.SendSMSRequest request);
        
        // CODEGEN: Generating message contract since element name account_name from namespace http://tempuri.org/ is not marked nillable
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/SendSMSAdvert", ReplyAction="*")]
        TestConsole.Test_Virtual_26.SendSMSAdvertResponse SendSMSAdvert(TestConsole.Test_Virtual_26.SendSMSAdvertRequest request);
    }
    ...
    public partial class SendSMSRequest {
        ...
        public TestConsole.Test_Virtual_26.SendSMSRequestBody Body;
        
        public SendSMSRequest() {
        }
        
        public SendSMSRequest(TestConsole.Test_Virtual_26.SendSMSRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SendSMSResponse {
        ...
        public TestConsole.Test_Virtual_26.SendSMSResponseBody Body;
        
        public SendSMSResponse() {
        }
        
        public SendSMSResponse(TestConsole.Test_Virtual_26.SendSMSResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SendSMSAdvertRequest {
        ...
        public TestConsole.Test_Virtual_26.SendSMSAdvertRequestBody Body;
        
        public SendSMSAdvertRequest() {
        }
        
        public SendSMSAdvertRequest(TestConsole.Test_Virtual_26.SendSMSAdvertRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SendSMSAdvertResponse {
        ...
        public TestConsole.Test_Virtual_26.SendSMSAdvertResponseBody Body;
        
        public SendSMSAdvertResponse() {
        }
        
        public SendSMSAdvertResponse(TestConsole.Test_Virtual_26.SendSMSAdvertResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface SendMT2SoapChannel : TestConsole.Test_Virtual_26.SendMT2Soap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SendMT2SoapClient : System.ServiceModel.ClientBase<TestConsole.Test_Virtual_26.SendMT2Soap>, TestConsole.Test_Virtual_26.SendMT2Soap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        TestConsole.Test_Virtual_26.SendSMSResponse TestConsole.Test_Virtual_26.SendMT2Soap.SendSMS(TestConsole.Test_Virtual_26.SendSMSRequest request) {
        ...
        public long SendSMS(string account_name, string account_password, string User_ID, string Content, string Service_ID, string Command_Code, string Request_ID, string Message_Type, string Total_Message, string Message_Index, string IsMore, string Content_Type) {
            TestConsole.Test_Virtual_26.SendSMSRequest inValue = new TestConsole.Test_Virtual_26.SendSMSRequest();
            inValue.Body = new TestConsole.Test_Virtual_26.SendSMSRequestBody();
            ...
            TestConsole.Test_Virtual_26.SendSMSResponse retVal = ((TestConsole.Test_Virtual_26.SendMT2Soap)(this)).SendSMS(inValue);
            return retVal.Body.SendSMSResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        TestConsole.Test_Virtual_26.SendSMSAdvertResponse TestConsole.Test_Virtual_26.SendMT2Soap.SendSMSAdvert(TestConsole.Test_Virtual_26.SendSMSAdvertRequest request) {
        ...
        public int SendSMSAdvert(string account_name, string account_password, string Phonenumber, string Message, string SendFrom, string CommandCode, string RequestID) {
            TestConsole.Test_Virtual_26.SendSMSAdvertRequest inValue = new TestConsole.Test_Virtual_26.SendSMSAdvertRequest();
            inValue.Body = new TestConsole.Test_Virtual_26.SendSMSAdvertRequestBody();
            inValue.Body.account_name = account_name;
            inValue.Body.account_password = account_password;
            ...
            TestConsole.Test_Virtual_26.SendSMSAdvertResponse retVal = ((TestConsole.Test_Virtual_26.SendMT2Soap)(this)).SendSMSAdvert(inValue);
