...
namespace TestConsole.Ws_TestVirtualDB {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="Ws_TestVirtualDB.SendMT2Soap")]
    public interface SendMT2Soap {
        ...
        TestConsole.Ws_TestVirtualDB.SendSMSResponse SendSMS(TestConsole.Ws_TestVirtualDB.SendSMSRequest request);
        
        // CODEGEN: Generating message contract since element name account_name from namespace http://tempuri.org/ is not marked nillable
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/SendSMSAdvert", ReplyAction="*")]
        TestConsole.Ws_TestVirtualDB.SendSMSAdvertResponse SendSMSAdvert(TestConsole.Ws_TestVirtualDB.SendSMSAdvertRequest request);
    }
    ...
    public partial class SendSMSRequest {
        ...
        public TestConsole.Ws_TestVirtualDB.SendSMSRequestBody Body;
        
        public SendSMSRequest() {
        }
        
        public SendSMSRequest(TestConsole.Ws_TestVirtualDB.SendSMSRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SendSMSResponse {
        ...
        public TestConsole.Ws_TestVirtualDB.SendSMSResponseBody Body;
        
        public SendSMSResponse() {
        }
        
        public SendSMSResponse(TestConsole.Ws_TestVirtualDB.SendSMSResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SendSMSAdvertRequest {
        ...
        public TestConsole.Ws_TestVirtualDB.SendSMSAdvertRequestBody Body;
        
        public SendSMSAdvertRequest() {
        }
        
        public SendSMSAdvertRequest(TestConsole.Ws_TestVirtualDB.SendSMSAdvertRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SendSMSAdvertResponse {
        ...
        public TestConsole.Ws_TestVirtualDB.SendSMSAdvertResponseBody Body;
        
        public SendSMSAdvertResponse() {
        }
        
        public SendSMSAdvertResponse(TestConsole.Ws_TestVirtualDB.SendSMSAdvertResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface SendMT2SoapChannel : TestConsole.Ws_TestVirtualDB.SendMT2Soap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SendMT2SoapClient : System.ServiceModel.ClientBase<TestConsole.Ws_TestVirtualDB.SendMT2Soap>, TestConsole.Ws_TestVirtualDB.SendMT2Soap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        TestConsole.Ws_TestVirtualDB.SendSMSResponse TestConsole.Ws_TestVirtualDB.SendMT2Soap.SendSMS(TestConsole.Ws_TestVirtualDB.SendSMSRequest request) {
        ...
        public long SendSMS(string account_name, string account_password, string User_ID, string Content, string Service_ID, string Command_Code, string Request_ID, string Message_Type, string Total_Message, string Message_Index, string IsMore, string Content_Type) {
            TestConsole.Ws_TestVirtualDB.SendSMSRequest inValue = new TestConsole.Ws_TestVirtualDB.SendSMSRequest();
            inValue.Body = new TestConsole.Ws_TestVirtualDB.SendSMSRequestBody();
            ...
            TestConsole.Ws_TestVirtualDB.SendSMSResponse retVal = ((TestConsole.Ws_TestVirtualDB.SendMT2Soap)(this)).SendSMS(inValue);
            return retVal.Body.SendSMSResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        TestConsole.Ws_TestVirtualDB.SendSMSAdvertResponse TestConsole.Ws_TestVirtualDB.SendMT2Soap.SendSMSAdvert(TestConsole.Ws_TestVirtualDB.SendSMSAdvertRequest request) {
        ...
        public int SendSMSAdvert(string account_name, string account_password, string Phonenumber, string Message, string SendFrom, string CommandCode, string RequestID) {
            TestConsole.Ws_TestVirtualDB.SendSMSAdvertRequest inValue = new TestConsole.Ws_TestVirtualDB.SendSMSAdvertRequest();
            inValue.Body = new TestConsole.Ws_TestVirtualDB.SendSMSAdvertRequestBody();
            inValue.Body.account_name = account_name;
            inValue.Body.account_password = account_password;
            ...
            TestConsole.Ws_TestVirtualDB.SendSMSAdvertResponse retVal = ((TestConsole.Ws_TestVirtualDB.SendMT2Soap)(this)).SendSMSAdvert(inValue);
